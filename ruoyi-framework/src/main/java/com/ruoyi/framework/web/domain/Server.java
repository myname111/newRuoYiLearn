 ...
 */
public class Server {
    private static final long OSHI_WAIT_SECOND = 1000;
    /**
     * CPU相关信息
     */
    ...
    public void copyTo() {
        ...
        setMenInfo(hardware.getMemory());
        setSysInfo();
        setJvmInfo();
        setSysFiles(info.getOperatingSystem());
    }
     ...
     * @param memory
     */
    private void setMenInfo(GlobalMemory memory) {
